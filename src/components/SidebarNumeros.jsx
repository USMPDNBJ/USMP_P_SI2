...
export function ButtonHome({ colorC, route }) {
  ...
  return (
    <button
      onClick={route}
      className="">
      <svg width="50px" height="50px" viewBox="-4.16 -4.16 24.32 24.32" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000ff" stroke-width="0.00016"><g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)"><rect x="-4.16" y="-4.16" width="24.32" height="24.32" rx="2.9184" fill="#881515ff" strokewidth="0"></rect></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M8 0L0 6V8H1V15H4V10H7V15H15V8H16V6L14 4.5V1H11V2.25L8 0ZM9 10H12V13H9V10Z" fill="#ffffff"></path> </g></svg>
    </button>
  );
}
